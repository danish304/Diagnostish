...
namespace Diagnostish.Infrastructure.WmiHelpers
{
    public interface IExecutorWmi
    {
        void ExecuteSafeQuery(string query, string context, List<string> errors, List<string> criticalErrors, Action<ManagementObjectCollection> wmiAction);
    }

    public class ExecutorWmi : IExecutorWmi
    {
        public void ExecuteSafeQuery(string query, string context, List<string> errors, List<string> criticalErrors, Action<ManagementObjectCollection> wmiAction)
        {
            try
            {
